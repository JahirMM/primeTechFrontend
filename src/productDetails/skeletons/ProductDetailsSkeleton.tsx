function ProductDetailsSkeleton() {
  return (
    <div className="mt-20">
      <div className="px-5 mt-5 mb-3 md:mt-0">
        <div className="w-[250px] h-[250px] mb-4 rounded-lg bg-skeletonBackground animate-pulse"></div>
        ...
        <div className="w-16 h-3 mt-3 rounded-lg bg-skeletonBackground animate-pulse sm:mt-6 sm:mb-0"></div>
      </div>
      <div className="mb-4 flex px-5 gap-x-2 animate-pulse md:mt-0">
      ...
      <div className="mb-4 flex items-center gap-5 px-5 mt-5 animate-pulse md:mt-0">
        <div className="w-20 h-10 bg-skeletonBackground rounded-xl"></div>
        <div className="w-20 h-10 bg-skeletonBackground rounded-xl"></div>
      </div>
      <div className="mb-5 flex flex-col gap-2 px-5 mt-5 animate-pulse md:mt-0 md:row-start-2 md:row-end-3">
